...
if __name__ == '__main__':
    ...
    for i in range(0, len(data_IMU)):
        ...
        # # 更新循环量
        # p_k1 = p_k
        # x_ba_k1 = data_truth[count_truth][8:11]
        # =========================================================================================================
        # 输出
        data_aligning[0] = data_IMU[i][0]

        data_aligning[1:7] =data_IMU[i][1:7]

        data_aligning[7:9] = np.array([lat, lon])
        data_aligning[9:12] = data_truth[count_truth][8:11]
        data_output.append(data_aligning.copy())
        """[ seconds of week,gx, gy, gz, vx,vy,vz,latitude, longitude,roll, Pitch, Yaw,]"""
        # print(data_aligning[0])
    np.savetxt("outputData/output_ICM20602_414.txt", data_output, delimiter=" ")
